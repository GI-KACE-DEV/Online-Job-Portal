<?php $__env->startSection('content'); ?>
              ...
              <div class="col-xl-3 col-sm-6 mb-3">
                <div class="card text-white bg-info o-hidden h-100">
                  <div class="card-body pt-5 pb-5 d-flex align-items-center">
                    ...
                    <div class="ml-5">
                    <a href="dashboard/users">
                      <h3 style="color:white;">( <?php echo e(count($users)); ?> ) </h3>
    ...
    <i class="material-icons text-white md-5em">business_center</i>
                  ...
                  <div class="ml-5">
                  <a href="dashboard/jobs">
                    <h3 style="color:white;">( <?php echo e(count($activeJobs)); ?> )</h3>
    ...
    <i class="material-icons text-white md-5em">business</i>
                  ...
                  <div class="ml-5">
                  <a href="dashboard/companies">
                    <h3 style="color:white;">( <?php echo e(count($companies)); ?> )</h3>
...
<?php echo $__env->make('../admin/layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Downloads\JobFinder-Job-Portal-Laravel-Vue-Script-main\JobFinder-Job-Portal-Laravel-Vue-Script-main\resources\views/admin/index.blade.php ENDPATH**/ ?>