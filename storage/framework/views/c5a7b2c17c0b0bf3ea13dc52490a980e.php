<?php $__env->startSection('content'); ?>
       ...
       <div class="content-header">
        ...
        <div class="create-item">
            <a href=<?php echo e(route('adminCatCreate')); ?> class="theme-primary-btn btn btn-primary"><i class="material-icons">add</i>&nbsp;Create new category</a>
                                          ...
                                          <button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#categoryDelete-<?php echo e($category->id); ?>" type="button"><i class="material-icons">delete</i></button>
                                            ...
                                            <div class="modal fade" id="categoryDelete-<?php echo e($category->id); ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel-<?php echo e($category->id); ?>" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <h5 class="modal-title text-center" id="staticBackdropLabel-<?php echo e($category->id); ?>">Name: <?php echo e($category->name); ?></h5>
...
<?php echo $__env->make('../admin/layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Downloads\JobFinder-Job-Portal-Laravel-Vue-Script-main\JobFinder-Job-Portal-Laravel-Vue-Script-main\resources\views/admin/category/index.blade.php ENDPATH**/ ?>