      ...
      <div class="col-md-12 col-lg-8 mb-5">
        ...
        <div class="p-5 bg-white">
          ...
          <div class=" mb-8 bg-white">
            ...
            <p><?php echo e($job->number_of_vacancy); ?> vacancies.</p>
      ...
      <div class="col-lg-4">
        ...
        <div class="p-4 mb-3 bg-white">
          <h3 class="h5 text-black mb-3">Short Job Info</h3>
            <p> <?php echo e($job->company->cname ?? ''); ?></p>
            ...
            <p><a href="<?php echo e($job->company->website); ?>" target="_blank" class="btn btn-warning" style="width: 100%;">Visit Company Page</a></p>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Downloads\JobFinder-Job-Portal-Laravel-Vue-Script-main\JobFinder-Job-Portal-Laravel-Vue-Script-main\resources\views/frontend/jobs/show.blade.php ENDPATH**/ ?>