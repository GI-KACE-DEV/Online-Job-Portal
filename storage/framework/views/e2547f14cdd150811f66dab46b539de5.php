              ...
              <nav class="site-navigation text-right" role="navigation">
                <div class="container pr-0">
                  ...
                  <ul class="site-menu js-clone-nav d-none d-lg-block">
                    ...
                    <?php if(!Auth::check()): ?>
                    <li class="<?php echo e(request()->routeIs('/register') ? 'active' : ''); ?>"><a href="/register">For Job Seeker</a></li>
                    <li class="<?php echo e(request()->routeIs('employer.register') ? 'active' : ''); ?>"><a href="<?php echo e(route('employer.register')); ?>">For Companies</a></li>
                    <?php else: ?>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content pb-4">
      <div class="modal-header mt-2 mb-2">
        <h5 class="modal-title" id="login-modal"><?php echo e(__('User Login')); ?></h5>
...
unset($__errorArgs, $__bag); ?>
  ...
  <?php /**PATH C:\Users\user\Downloads\JobFinder-Job-Portal-Laravel-Vue-Script-main\JobFinder-Job-Portal-Laravel-Vue-Script-main\resources\views////frontend/partials/nav.blade.php ENDPATH**/ ?>