                        ...
                        <div class="col-md-4">
                          <div class="set_thumb">
                            ...
                            <div id='settings-favicon'>
                              <img id="preview-favicon" align='middle'src="<?php echo e(asset('backend/assets/images/icons/favicon.png')); ?>" alt="your image" title=''/>
                            </div>
...
<?php echo $__env->make('../admin/layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Downloads\JobFinder-Job-Portal-Laravel-Vue-Script-main\JobFinder-Job-Portal-Laravel-Vue-Script-main\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>