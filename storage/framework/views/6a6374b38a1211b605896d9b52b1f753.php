                      ...
                      <div class="table-responsive">
                          <table id="usersTable" class="table table-striped table-borderless" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <?php $i=0; ?>
                                <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php $i++ ?>
                                          ...
                                          <button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#employerDelete-<?php echo e($employer->id); ?>" type="button"><i class="material-icons">delete</i></button>
                                            ...
                                            <div class="modal fade" id="employerDelete-<?php echo e($employer->id); ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel-<?php echo e($employer->id); ?>" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <h5 class="modal-title text-center" id="staticBackdropLabel-<?php echo e($employer->id); ?>"> <?php echo e($employer->company->cname); ?></h5>
...
<?php echo $__env->make('../admin/layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Downloads\JobFinder-Job-Portal-Laravel-Vue-Script-main\JobFinder-Job-Portal-Laravel-Vue-Script-main\resources\views/admin/employers/index.blade.php ENDPATH**/ ?>